      ...
      <div className="bg-white border rounded-lg p-6">
        ...
        <ResponsiveContainer width="100%" height={400}>
          <LineChart data={chartData} margin={{ left: 30, right: 20, top: 5, bottom: 25 }}>
            ...
            />
            <YAxis tickFormatter={formatCurrency} stroke="#666" width={80} label={{ value: 'Change in Net Income', angle: -90, position: 'insideLeft', offset: -20, style: { fill: '#666', fontSize: 12, textAnchor: 'middle' } }} />
            <Tooltip
